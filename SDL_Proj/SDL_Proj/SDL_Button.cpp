...
BUTTON* InitButton(SDL_Renderer* screen, const char* szUp, const char* szDown, const char* szOver, int x, int y, void(*f)(void))
{
	BUTTON* Temp;
	...
	SDL_SetColorKey(imgTemp, SDL_TRUE, ColorKey);
	Temp->imgOver = SDL_CreateTextureFromSurface(screen, imgTemp);
